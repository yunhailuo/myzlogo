...
class List_Context extends antlr4.ParserRuleContext {
	...
	OPEN_LIST() {
	    return this.getToken(UCBLogoParser.OPEN_LIST, 0);
	};

	CLOSE_LIST() {
	    return this.getToken(UCBLogoParser.CLOSE_LIST, 0);
	};
	...
	WORD = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(UCBLogoParser.WORD);
	    } else {
	        return this.getToken(UCBLogoParser.WORD, i);
	    }
	};
